...
Source.create(name: 'Andy Kravis, Cruciverbalist at Law', display_name: 'Cruciverbalist at Law', url: 'http://cruciverbalistatlaw.blogspot.ca', description: 'New puzzle every weekend', :constructors => Constructor.where(:name => 'Andy Kravis'), editor: 'Andy Kravis')
Source.create(name: 'Neville Fogarty', display_name: 'Neville Fogarty', url: 'http://nevillefogarty.wordpress.com', description: 'Puzzles by Neville. Updated every Friday', constructors: neville_constructors, editor: 'Neville Fogarty')
Source.create(name: '20 Under 30', display_name: '20 Under 30', description: 'A unique and exclusive collection of 20 crossword puzzles written by constructors under 30 years of age, edited by Ben Tausig.', url: 'http://www.20under30.com', editor: 'Ben Tausig')
