...
Source.create(name: 'Anoa Place (Where We Can Go)', display_name: 'Anoa Place',  url: 'http://terpconnect.umd.edu/~eagard/home.html', description: '14-puzzle miniseries by Erik Agard', :constructors => Constructor.where(:name => 'Erik Agard'))
...
Source.create(name: 'The Cross Nerd', display_name: 'Cross Nerd', url: 'http://thecrossnerd.blogspot.com', description: 'A sassy and irreverent take on crossword puzzles. Reviews, musings, epiphanies, and a new free puzzle every Tuesday morning.', constructors: crossnerd_constructors)
...
Source.create(name: 'Andy Kravis, Cruciverbalist at Law', display_name: 'Andy Kravis', url: 'http://cruciverbalistatlaw.blogspot.ca/', description: 'New puzzle every weekend', :constructors => Constructor.where(:name => 'Andy Kravis'))
Source.create(name: 'The Chronicle of Higher Education', display_name: 'CHE', url: 'http://chronicle.com/section/Crosswords/43/', description: 'Puzzles every Friday (every second Friday over the summer')
